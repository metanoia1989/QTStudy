...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        open_file_action = QAction(getIcon("blue-folder-open-document"), "Open file...", self)
        ...
        redo_action = QAction(getIcon("arrow-curve"), "Redo", self)
        ...
        # 连接到产生当前选择文本的信号。将字符串转换为float并设置为pointsize。我们还可以使用index+从字体大小检索
        self.fontsize.currentIndexChanged.connect(lambda s: self.editor.setFontPointSize(float(s)))
        format_toolbar.addWidget(self.fontsize)

        self.bold_action = QAction(getIcon("edit-bold"), "Bold", self)
        ...
        self.italic_action = QAction(getIcon("edit-italic"), "Italic", self)
        ...
        self.underline_action = QAction(getIcon('edit-underline'), "Underline", self)
        ...
        self.alignl_action = QAction(getIcon('edit-alignment'), "Align left", self)
        ...
        self.alignc_action = QAction(getIcon('edit-alignment-center'), "Align center", self)
        ...
        self.alignr_action = QAction(getIcon('edit-alignment-right'), "Align right", self)
        ...
        self.alignj_action = QAction(getIcon('edit-alignment-justify'), "Justify", self)
    ...
    def file_save(self):
        ...
        text = self.editor.toHtml() if splitext(self.path) in HTML_EXTENSIONS \
    ...
    def file_saveas(self):
        path, _ = QFileDialog.getSaveFileName(self, "Save file", "", 
            "HTML documents (*.html);;Text document (*.txt);;All files (*.*)")

        if not path:
            return

        text = self.editor.toHtml() if splitext(path) in HTML_EXTENSIONS \
            else self.editor.toPlainText()

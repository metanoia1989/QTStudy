...
{
    QString xStr;	// 获取 x() 函数的结果并显示
    xValueLabel->setText(xStr.setNum(x()));
    QString yStr;	// 获取 y() 函数的结果并显示
    yValueLabel->setText(yStr.setNum(y()));

    QString frameStr;	// 获取 frameGeometry() 函数的结果并显示
    ...
    QString sizeStr;	// 获取 size() 函数的结果并显示

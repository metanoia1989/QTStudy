    ...
    : QWidget(parent)
{
    ...
    shapeComboBox->addItem(tr("Line"), PaintArea::Line); // 插入文本及对应的数据
    ...
    shapeComboBox->addItem(tr("Pximap"), PaintArea::Pixmap);
    ...
    penJoinComboBox->addItem(tr("BeveJoin"), Qt::BevelJoin);

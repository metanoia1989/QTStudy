...
Window {
    ...
    Win.TaskbarButton {
        ...
        overlay.iconSource: mediaPlayer.playbackState === MediaPlayer.PlayingState
                        ? "qrc:/images/play-32.png"
                        : mediaPlayer.PlayingState === MediaPlayer.PlayingState
                        ? "qrc:/images/pause-32.png" : "qrc:/images/stop-32.png"
    ...
    Win.ThumbnailToolBar {
        ...
        Win.ThumbnailToolButton {
            ...
            onClicked: mediaPlayer.playbackState === MediaPlayer.PlayingState
                ? mediaPlaer.paused() : mediaPlayer.play()
        }
        Win.ThumbnailToolButton {

...
class Widget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        QTimer.singleShot(3000, self.giveHelp) # 避免窗口大小重绘事件的影响

    def giveHelp(self):
        self.text = "请点击这里触发跟踪鼠标功能"
        self.update() # 重绘事件，触发 paintEvent 函数
    ...
    Tab键由于涉及焦点切换，不会传递给keyPressEvent，
    因此需要在这里重新定义
    '''

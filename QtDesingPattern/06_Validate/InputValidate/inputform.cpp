...
InputForm::InputForm(int ibot, int itop, double dbot,
    double dtop, QWidget *parent)
    : QWidget(parent)
...
void InputForm::setupForm()
{
    ...
    connect(m_IntEntry, &QLineEdit::returnPressed, this,
            &InputForm::computeResult);
    connect(m_DoubleEntry, &QLineEdit::returnPressed, this,
            &InputForm::computeResult);
}
